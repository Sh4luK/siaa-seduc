...
export default function FrequenciaIndexPage() {
            ...
            <div className={styles.headerRow}>
              <div>
                ...
                <p className={layoutStyles.subtitle}>
                  Olá, {firstName}. Escolha a turma e a disciplina para registrar a frequência.
                </p>
              </div>
              <Link href="/professor/frequencia/registros" className={styles.historicoBotao}>
                  ...
                  <li key={grupo.nomeTurma} className={styles.turmaCard}>
                    ...
                    <div className={styles.disciplinasChips}>
                      {grupo.opcoes.map((opcao) => (
                        <Link
                          key={opcao.id}
                          href={`/professor/frequencia/turma/${opcao.id}`}
