...
export default function RegistrosFrequenciaPage() {
  ...
  const registrosFiltrados = useMemo(() => {
    ...
    return registros.filter((r) => {
      const alvo = [r.nome_turma, r.disciplina, r.assunto, formatarData(r.data)]
        .filter(Boolean)
        .join(" ")
        .toLowerCase();
        ...
        <div className={layoutStyles.content}>
          ...
          <main className={layoutStyles.main}>
            ...
            <div className={styles.buscaWrapper}>
              ...
              <input
                type="text"
                placeholder="Buscar por turma, disciplina, assunto ou data..."
            ...
            {registrosFiltrados.length === 0 ? (
              <p className={styles.vazio}>
                {busca
                  ...
                  : "Nenhum registro de frequência encontrado ainda."}
              </p>
            ) : (
              <ul className={styles.registrosList}>
