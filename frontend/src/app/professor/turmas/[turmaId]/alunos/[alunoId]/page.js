...
//         const notasUrl = `${API_BASE}/api/teacher/notas/get?aluno=${alunoId}&turma=${turmaId}&disciplina=${discId}&professor=${profId}`;
//         const notasRes = await fetch(notasUrl);
...
//         const discId = turmaData.turma?.disciplina_id;
//         const nomeDisc = turmaData.turma?.disciplina_lecionada || "";

//         if (!discId) {
//           throw new Error("Não foi possível resolver o ID da disciplina a partir da turma.");
//         }
//         setDisciplinaId(discId);
//         setNomeDisciplina(nomeDisc);
