...
//       try {
//         const urlAuth = "https://obscure-happiness-v67rpjq7p96vfxj4g-8000.app.github.devapi/teacher/auth";
...
//       try {
//         const urlTurmas = `https://obscure-happiness-v67rpjq7p96vfxj4g-8000.app.github.devapi/teacher/search/turmas?nome_completo=${encodeURIComponent(nomeCompleto)}`;
//         const urlDisciplinas = `https://obscure-happiness-v67rpjq7p96vfxj4g-8000.app.github.devapi/teacher/search/disciplinas?nome_completo=${encodeURIComponent(nomeCompleto)}`;
...
//       try {
//         const url = `https://obscure-happiness-v67rpjq7p96vfxj4g-8000.app.github.devapi/teacher/search/turma?turma=${turmaId}`
//         const response = await fetch(url)
...
//       try {
//         const getTurma = await fetch(`https://obscure-happiness-v67rpjq7p96vfxj4g-8000.app.github.devapi/teacher/search/turma?turma=${turmaId}`)
...
//           return
//         }
//         //https://obscure-happiness-v67rpjq7p96vfxj4g-8000.app.github.devapi/teacher/get/alunos?turma=EMTPDES-SIS-2%C2%AA%20SERIE-INTEGRAL-I-A
//         const turmaName = encodeURIComponent(turmaObj["turma"])
//         const urlAlunos = `https://obscure-happiness-v67rpjq7p96vfxj4g-8000.app.github.devapi/teacher/get/alunos?turma=${turmaName}`
