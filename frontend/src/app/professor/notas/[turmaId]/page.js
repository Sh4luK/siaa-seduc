              ...
              <>
                <div className={styles.hero}>
                  <div className={styles.heroInfo}>
                    ...
                    <span className={styles.heroChip}>{disciplinaEscolhida.disciplina}</span>
                  </div>
                ...
                {carregandoNotas ? (
                  ...
                  <>
                              ...
                              <tr key={aluno.aluno_id}>
                                ...
                                {CAMPOS.map((campo) => (
                                  <td key={campo}>
                                    <input
                                      type="text"
                                      inputMode="decimal"
                                      className={`${styles.input} ${corDaNota(aluno.notas[campo])}`}
                                ...
                                <td>
                                  <input
                                    type="text"
                                    inputMode="decimal"
                                    className={`${styles.input} ${corDaNota(aluno.notas.pf)}`}
                                ...
                                <td>
                                  <input
                                    type="text"
                                    inputMode="decimal"
                                    className={`${styles.input} ${corDaNota(aluno.notas.rcf)}`}
                    ...
                    <a
                      href={`${API_BASE}/api/teacher/notas/turma/${disciplinaEscolhida.turma_id}/ficha-pdf?professor=${professorId}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className={styles.botaoBaixarFicha}
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
