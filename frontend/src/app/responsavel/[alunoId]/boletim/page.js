  ...
  useEffect(() => {
    async function init() {
      try {
        ...
        const res = await fetch(`${API_BASE}/api/responsavel/alunos/${alunoId}/boletim`, { credentials: "include" });
              ...
              <>
                <div className={styles.tabelaWrapper}>
                  <table className={styles.tabela}>
                    {/* ...thead e tbody continuam iguais... */}
                    <thead>
                      <tr>
                ...
                <a
                  href={`${API_BASE}/api/responsavel/alunos/${alunoId}/boletim/pdf`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className={styles.botaoEmitirBoletim}
                >
