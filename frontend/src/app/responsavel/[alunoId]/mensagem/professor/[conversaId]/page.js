...
export default function ConversaProfessorResponsavelPage() {
    ...
    <div className={styles.page}>
      ...
      <div className={styles.content}>
        <div className={styles.cabecalho}>
          <Link href={`/responsavel/${alunoId}/mensagem/professor`} className={styles.voltar}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="19" y1="12" x2="5" y2="12" /><polyline points="12 19 5 12 12 5" /></svg>
          </Link>
          <div className={styles.avatar}>{conversa?.professor_nome?.charAt(0)?.toUpperCase() || "P"}</div>
          <span className={styles.professorNome}>{conversa?.professor_nome || "Carregando..."}</span>
        </div>
