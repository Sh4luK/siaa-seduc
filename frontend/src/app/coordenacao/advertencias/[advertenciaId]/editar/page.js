...
export default function EditarAdvertenciaPage() {
  ...
  // faltavam estes três — causavam "setIsSuspensao is not defined"
  ...
  async function handleSubmit(e) {
    ...
    if (tipo === "ADVERTENCIA" && isSuspensao && (!dataInicioSuspensao || !dataTerminoSuspensao)) {
      setErros(["Preencha o início e o término da suspensão."]);
      return;
    }
          ...
          {tipo === "ADVERTENCIA" && (
            <div className={styles.campo}>
              <label className={styles.checkboxLabel}>
                ...
                />
                Esta advertência implica suspensão
              </label>

              {isSuspensao && (
                <div className={styles.suspensaoCampos}>
                  <div className={styles.campo}>
                    <label className={styles.label} htmlFor="inicioSuspensao">Início</label>
                    <input
                      id="inicioSuspensao"
                      type="date"
                      className={styles.input}
                  ...
                  <div className={styles.campo}>
                    <label className={styles.label} htmlFor="terminoSuspensao">Término</label>
                    <input
                      id="terminoSuspensao"
                      type="date"
                      className={styles.input}
