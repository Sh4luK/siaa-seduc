...
//         const res = await fetch(`${API_BASE}/api/coordenacao/alunos/${alunoId}`);
//         if (!res.ok) throw new Error(`Falha ao buscar aluno (status ${res.status})`);
