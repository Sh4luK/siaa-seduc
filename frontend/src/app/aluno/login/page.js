...
//         try {
//             const response = await fetch(`https://obscure-happiness-v67rpjq7p96vfxj4g-8000.app.github.devapi/students/search?fullname=${encodeURIComponent(fullName)}`);
...
//         try {
//             const url = `https://obscure-happiness-v67rpjq7p96vfxj4g-8000.app.github.devapi/students/login?fullname=${encodeURIComponent(fullName)}&password=${password}`
...
//     }
//     const authUrl = "https://obscure-happiness-v67rpjq7p96vfxj4g-8000.app.github.devapi/students/auth"
...
export default function AlunoLoginPage() {
  ...
  async function verify_full_name() {
    ...
    try {
      ...
      const nameSearched = clearName(fullName.trim().toUpperCase().replace(/\s+/g, " "));
      const studentNameOnDataBase = data?.estudante?.[0]?.nome_completo
        ? clearName(data.estudante[0].nome_completo)
        : "";
