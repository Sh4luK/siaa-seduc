...
urlpatterns = [
    ...
    path("api/blog/login", app.views.blog_login, name="blog_login"),
    path("api/blog/auth", app.views.blog_auth, name="blog_auth"),
    path("api/blog/posts/<int:post_id>/curtir", app.views.curtir_post, name="curtir_post"),
    path("api/blog/posts/<int:post_id>/comentarios", app.views.comentar_post, name="comentar_post"),
    path("api/blog/comentarios/<int:comentario_id>", app.views.deletar_comentario, name="deletar_comentario"),
    ...
    path('api/students/boletim/pdf', app.views.boletim_aluno_pdf),
    ...
    path('api/blog/perfil/<str:nome_usuario>', app.views.get_perfil_blog),
    path('api/blog/perfil/<str:nome_usuario>/editar', app.views.editar_perfil_blog),
