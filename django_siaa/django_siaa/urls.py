...
urlpatterns = [
    ...
    path('api/coordenacao/advertencias', app.views.views.get_advertencias_coordenacao, name='get_advertencias_coordenacao'),
    ...
    path('api/coordenacao/advertencias/<int:advertencia_id>/editar', app.views.views.editar_advertencia_coordenacao, name='editar_advertencia_coordenacao'),
